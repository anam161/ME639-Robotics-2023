...
Original file is located at
    https://colab.research.google.com/drive/1D-5_plhIYPlF1wwrYHs0IOkd_Gxlv3eb
"""
...
y2_middle = L1 * np.sin(theta1) + PIP * np.sin(theta1 + theta3) 
...
opposition_spaces = np.zeros((12, 12))

hull_points_list = [hull_points1_thumb, hull_points2_thumb, hull_points3_thumb,
                    hull_points1_index, hull_points2_index, hull_points4_index,
...
labels = [
    "F1 MCP", "F1 PIP", "F1 DIP",
    "F2 MCP", "F2 PIP", "F2 DIP",
    "F3 MCP", "F3 PIP", "F3 DIP",
    "F4 MCP", "F4 PIP", "F4 DIP"
]

# Create a heatmap to visualize the opposition spaces
plt.figure(figsize=(12, 10))
sns.heatmap(opposition_spaces, annot=True, fmt=".0f", cmap="Blues", xticklabels=labels, yticklabels=labels)
plt.title("Existing Opposition Spaces (d = 20mm)")
